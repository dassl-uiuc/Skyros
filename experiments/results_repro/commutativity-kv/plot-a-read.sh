...
(cat <<EOF
	...
	plot "orig_read" using 2:1 title "Paxos" with lines dashtype 3 lw 4 lc rgb "red",\
		"rtop_read" using 2:1 title "Skyros" with lines dashtype 4 lw 4 lc rgb "blue",\
		"curp_read" using 2:1 title "Curp-c" with lines dashtype 1 lw 4 lc rgb "green" 
