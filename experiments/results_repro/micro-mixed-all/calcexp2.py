...
client = 10
#workloads = ['w', 'a', 'b', 'c', 'd', 'f']
workloads = ['mw0.1.uniform', 'mw0.3.uniform', 'mw0.5.uniform', 'mw0.7.uniform', 'mw0.9.uniform']
code = sys.argv[1]
run_ids =[ '1']
d = sys.argv[2]
...
for workload in workloads:
	...
	for run_id in run_ids:
		...
		#sys.exit(0)
	#
	print workload, mean(t_put_total)/1000.0, mean(avg_lat_total), t_put_total#, stdev(t_put_total)/1000.0
